...
app.get('/users', async (req: Request, res: Response) => {
    ...
    res.send(`Highiest users similrity score are user: ${highScore.peer1_id} and user: ${highScore.peer2_id}`);
});
...
app.get('/companies', async (req: Request, res: Response) => {
    ...
    res.send(`Highiest companies similrity score are company: ${highScore.peer1_id} and company: ${highScore.peer2_id}`);
});
